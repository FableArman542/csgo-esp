...
dwForceAttack = (0x3180754)
dwForceAttack2 = (0x3180760)
dwForceBackward = (0x31807A8)
dwForceForward = (0x3180784)
dwForceJump = (0x51F8E14)
dwForceLeft = (0x318079C)
dwForceRight = (0x31807C0)
dwGameDir = (0x6285F8)
dwGameRulesProxy = (0x526C114)
dwGetAllClasses = (0xD6123C)
dwGlobalVars = (0x589AD8)
dwGlowObjectManager = (0x5296FB0)
dwInput = (0x51A07D8)
dwInterfaceLinkList = (0x905024)
dwLocalPlayer = (0xD3AC5C)
dwMouseEnable = (0xD40800)
dwMouseEnablePtr = (0xD407D0)
dwPlayerResource = (0x317EAE0)
dwRadarBase = (0x5183F6C)
dwSensitivity = (0xD4069C)
dwSensitivityPtr = (0xD40670)
dwSetClanTag = (0x89E50)
dwViewMatrix = (0x4D40B44)
dwWeaponTable = (0x51A1298)
dwWeaponTableIndex = (0x325C)
dwYawPtr = (0xD40460)
dwZoomSensitivityRatioPtr = (0xD45700)
dwbSendPackets = (0xD420A)
dwppDirect3DDevice9 = (0xA7030)
m_pStudioHdr = (0x294C)
m_yawClassPtr = (0xD40460)
m_pitchClassPtr = (0x5184208)
interface_engine_cvar = (0x3E9EC)
convar_name_hash_table = (0x2F0F8)
m_bDormant = (0xED)
r_model_ambient_min = (0x58CE4C)
set_abs_angles = (0x1D4110)
set_abs_origin = (0x1D3F50)
is_c4_owner = (0x3ACDF0)
force_update_spectator_glow = (0x3A0362)
anim_overlays = (0x2980)
m_flSpawnTime = (0xA370)
find_hud_element = (0x29431330)
